                ...
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !La.includes(e) && !Aa.includes(e)))
                    return (
                      ...
                      void this.addToast(
                        "There is not a cyclist with this name (at least among the ones of the current database)"
                      )
                    );
                  if (this.hardMode) {
                    ...
                    if (!o)
                      return (
                        a.setAttribute("invalid", ""),
                        void this.addToast(
                          r || "Non valido quando il gioco si fa duro"
                        )
                      );
                  }
                  var n = (function (e, a) {
                      ...
                      us(
                        (function (e) {
                          var a = e.evaluations,
                            ...
                            current = s,
                            l =
                              "BIKLE 🚲 - A wordle-like game by Bidon - ciclismo allo stato liquido. My results today: Bikle " +
                              current +
                              "";
