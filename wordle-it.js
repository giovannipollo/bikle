this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var Qa = "IN_PROGRESS",
        Za = "WIN",
        es = "FAIL",
        as = ["Merckx the cannibal!", "Rainbow Jersey!", "Hors catégorie!", "Breakaway specialist!", "Grupetto!", "Black Jersey!"],
        ss = function (e) {
            n(t, e);
            var a = h(t);
    ...
    fs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Trova i <strong>Ciclisti</strong> tra quelli più noti attualmente in attività il cui nome è composto da 5 lettere. Hai 6 tentativi in tutto.</p>\n      <p>BIKLE è una versione modificata (non ufficiale) di <a href="https://powerlanguage.co.uk/wordle/">WORDLE</a> e della sua edizione italiana <a href="https://pietroppeter.github.io/wordle-it/">PARoLE</a> di cui riprende il codice. Solo che questa modifica è riservata ai fanatici di politica!</p>\n      <p>Dopo ogni tentativo, i colori delle tessere cambieranno per mostrarti quanto vicino sei andato a indovinare la parola.</p>\n      <div class="examples">\n        <div class="example">\n          <div class="row">\n            <game-tile letter="b" evaluation="correct" reveal></game-tile>\n            <game-tile letter="i"></game-tile>\n            <game-tile letter="n"></game-tile>\n            <game-tile letter="d"></game-tile>\n            <game-tile letter="a"></game-tile>\n          </div>\n          <p>La lettera <strong>B</strong> è nella parola ed è nel posto giusto.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="o"></game-tile>\n            <game-tile letter="p" evaluation="present" reveal></game-tile>\n            <game-tile letter="p"></game-tile>\n            <game-tile letter="i"></game-tile>\n          </div>\n          <p>La lettera <strong>P</strong> è nella parola ma nel posto sbagliato.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="t" evaluation="absent" reveal></game-tile>\n            <game-tile letter="o"></game-tile>\n          </div>\n          <p>La lettera <strong>T</strong> non è nella parola.</p>\n        </div>\n      </div>\n      <p>Torna anche domani! Ogni giorno <strong>un ciclista</strong> diverso</p>\n   <p>Ideato da <strong>Bidon</strong></a>  (<a href="https://t.me/ciclismoliquido"><strong>Telegram di Bidon</strong></a>, <a href="https://twitter.com/ciclismoliquido"><strong>Twitter di Bidon</strong></a>) </p>\n   </div>\n  </section>\n';
    var ks = function (e) {
        n(t, e);
        var a = h(t);
