this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color blind mode</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Do you like it?</div>\n        </div>\n        <div class="control">\n          <a href="https://github.com/giop98/bikle" target="blank" title="https://github.com/giop98/bikle">Code on GitHub</a>\n          |\n          <a href="https://twitter.com/ciclismoliquido" target="blank" title="@ciclismoliquido">Twitter of Bidon</a>\n      |\n          <a href="https://t.me/ciclismoliquido" target="blank" title="https://t.me/ciclismoliquido">Telegram of Bidon</a>\n   |\n          <a href="https://www.bidonmagazine.org/" target="blank" title="@ciclismoliquido">Website of Bidon</a>\n    </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="puzzle-number"></div>\n    <div id="hash"></div>\n  <div>\n';
    var _a = function (e) {
        n(t, e);
        var a = h(t);
                    ...
                    for (var a = this.shadowRoot.getElementById("statistics"), s = this.shadowRoot.getElementById("guess-distribution"), t = Math.max.apply(Math, g(Object.values(this.stats.guesses))), o = 1; o < Object.keys(this.stats.guesses).length; o++) {
                        ...
                        us(function (e) {
                            var a = e.evaluations,
                                ...
                                i = JSON.parse(window.localStorage.getItem(S)),
                                l = "BIKLE 🚲 - The wordle-like game for ciclyng fans by Bidon (https://www.bidonmagazine.org/). Play here https://bit.ly/bikle - My results today";
